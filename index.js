...
function añadirOtro() {
        ...
        document.getElementById("prueba").appendChild(window['dupproducto'+iterator]);
        document.getElementById("prueba").appendChild(window['dupcantidad'+iterator]);
        iterator++;
}
...
function cotizar() {
    ...
    var div = document.createElement ("div");
    div.innerHTML = `
    <p> ${outputProducto}   $${precio}   ${outputCantidad}</p>;
    `
    ...
    var div = document.createElement ("div");
    div.innerHTML = `
    <p> ${ImpresionProd}   $${precio1}   ${ImpresionCant}</p>;
    `
    cotizacion.append(div);  
}
